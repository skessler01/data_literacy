...
def get_all_locations(df: pd.DataFrame = data) -> pd.DataFrame:
...
def locations_in_domain(domain_name: str, df: pd.DataFrame = data) -> pd.DataFrame:
...
def filter_data_by_channels(channel_names: list, df: pd.DataFrame = data) -> pd.DataFrame:
